...
## Environments
- Preview: https://main--thomsebastin-250814--aemysites.aem.page/
- Live: https://main--thomsebastin-250814--aemysites.aem.live/
...
1. Open the `thomsebastin-250814` directory in your favorite IDE and start coding :)
